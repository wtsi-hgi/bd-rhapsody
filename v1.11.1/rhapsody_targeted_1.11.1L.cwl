    ...
    "$graph": [
            ...
            "requirements": [
                {
                    ...
                    "dockerPull": "bdgenomics/rhapsody:1.11.1L"
                },
                {
        ...
        },
        {
            "requirements": [
                {
                    "class": "ResourceRequirement",
                    "ramMin": "${return Math.min(Math.max(parseInt(inputs.num_cell_estimate * inputs.num_bioproducts * 3 / 100000 * 2), 32000), 384000);}"
                },
                {
                    "class": "DockerRequirement",
                    "dockerPull": "bdgenomics/rhapsody:1.11.1L"
        ...
        {
            "class": "Workflow",
            "label": "BD Rhapsody\u2122 Targeted Analysis Pipeline 1.11.1 Large Input",
                        ...
                        "inputs": [
                            {
                                ...
                                "id": "#main/MergeMultiplex/6243ee4f-9712-4d04-9f23-b85cd5c9686d/SampleTag_Files"
                            }
                        ],
                        "outputs": [
                            {
                                ...
                                "id": "#main/MergeMultiplex/6243ee4f-9712-4d04-9f23-b85cd5c9686d/Multiplex_out"
                            }
                        ],
                        "expression": "${\n  var fp_array = [];\n  for (var i = 0; i < inputs.SampleTag_Files.length; i++) {\n    var fp = inputs.SampleTag_Files[i];\n    if (fp != null) {\n      fp_array.push(fp);\n    }\n  }\n  return({\"Multiplex_out\": fp_array});\n}",
                        "id": "#main/MergeMultiplex/6243ee4f-9712-4d04-9f23-b85cd5c9686d"
                    },
                    "in": [
                        {
                            "source": [
                ...
                },
                {
                    "run": {
                        ...
                        "outputs": [
                            {
                                "type": "string",
                                "id": "#main/Start_Time/c5e5127e-7b3d-4741-bac4-c784d1ab7c90/Start_Time"
                            }
                        ],
                        "expression": "${   \n  var today = new Date();\n  var date = today.toString()\n  return ({Start_Time: date});\n} ",
                        "id": "#main/Start_Time/c5e5127e-7b3d-4741-bac4-c784d1ab7c90"
                    },
                    "in": [],
                    "out": [
