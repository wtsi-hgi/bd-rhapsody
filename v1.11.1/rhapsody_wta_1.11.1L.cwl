#!/usr/bin/env cwl-runner
{
    "$graph": [
        ...
        {
            "class": "Workflow",
            "label": "BD Rhapsody\u2122 WTA Analysis Pipeline 1.11.1 Large Input",
                        ...
                        "inputs": [
                            {
                                ...
                                "id": "#main/MergeMultiplex/22d8c47e-a547-494b-8785-6b9ce52d9200/SampleTag_Files"
                            }
                        ],
                        "outputs": [
                            {
                                ...
                                "id": "#main/MergeMultiplex/22d8c47e-a547-494b-8785-6b9ce52d9200/Multiplex_out"
                            }
                        ],
                        "expression": "${\n  var fp_array = [];\n  for (var i = 0; i < inputs.SampleTag_Files.length; i++) {\n    var fp = inputs.SampleTag_Files[i];\n    if (fp != null) {\n      fp_array.push(fp);\n    }\n  }\n  return({\"Multiplex_out\": fp_array});\n}",
                        "id": "#main/MergeMultiplex/22d8c47e-a547-494b-8785-6b9ce52d9200"
                    },
                    "in": [
                        {
                            "source": [
                ...
                },
                {
                    "run": {
                        ...
                        "outputs": [
                            {
                                "type": "string",
                                "id": "#main/Start_Time/974f66e8-3058-4ea7-9b67-a7aeedfe4515/Start_Time"
                            }
                        ],
                        "expression": "${   \n  var today = new Date();\n  var date = today.toString()\n  return ({Start_Time: date});\n} ",
                        "id": "#main/Start_Time/974f66e8-3058-4ea7-9b67-a7aeedfe4515"
                    },
                    "in": [],
                    "out": [
