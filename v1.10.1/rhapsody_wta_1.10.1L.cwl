#!/usr/bin/env cwl-runner
{
    "$graph": [
        ...
        {
            "class": "Workflow",
            "label": "BD Rhapsody\u2122 WTA Analysis Pipeline 1.10.1 Large Input",
            ...
            "steps": [
                ...
                },
                {
                    "run": {
                        ...
                        "inputs": [
                            {
                                ...
                                "id": "#main/FindDataTableForCellClassifier/461c39bb-2eaf-42db-b966-aa6b207dd88d/dataTables"
                            }
                        ],
                        "outputs": [
                            {
                                "type": "File",
                                "id": "#main/FindDataTableForCellClassifier/461c39bb-2eaf-42db-b966-aa6b207dd88d/molsPerCellMatrixForCellClassifier"
                            }
                        ],
                        ...
                        "id": "#main/FindDataTableForCellClassifier/461c39bb-2eaf-42db-b966-aa6b207dd88d"
                    },
                    "in": [
                        {
                        ...
                        "inputs": [
                            {
                                ...
                                "id": "#main/MergeMultiplex/3e568d0a-b87f-4c68-8a0a-6b4e1d6d9e99/SampleTag_Files"
                            }
                        ],
                        "outputs": [
                            {
                                ...
                                "id": "#main/MergeMultiplex/3e568d0a-b87f-4c68-8a0a-6b4e1d6d9e99/Multiplex_out"
                            }
                        ],
                        "expression": "${\n  var fp_array = [];\n  for (var i = 0; i < inputs.SampleTag_Files.length; i++) {\n    var fp = inputs.SampleTag_Files[i];\n    if (fp != null) {\n      fp_array.push(fp);\n    }\n  }\n  return({\"Multiplex_out\": fp_array});\n}",
                        "id": "#main/MergeMultiplex/3e568d0a-b87f-4c68-8a0a-6b4e1d6d9e99"
                    },
                    "in": [
                        {
                            "source": [
                ...
                },
                {
                    "run": {
                        ...
                        "outputs": [
                            {
                                "type": "string",
                                "id": "#main/Start_Time/8810886b-e0e8-47b8-af53-2151a70bc9ef/Start_Time"
                            }
                        ],
                        "expression": "${   \n  var today = new Date();\n  var date = today.toString()\n  return ({Start_Time: date});\n} ",
                        "id": "#main/Start_Time/8810886b-e0e8-47b8-af53-2151a70bc9ef"
                    },
                    "in": [],
                    "out": [
